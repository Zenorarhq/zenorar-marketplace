...
const countryMeta: Record<string, { name: string; dialCode: string; flag: string; retail: number }> = {
  ...
  BB: { name: 'Barbados', dialCode: '+1246', flag: '🇧🇧', retail: 5.00 },
  BJ: { name: 'Benin', dialCode: '+229', flag: '🇧🇯', retail: 5.00 },
  DZ: { name: 'Algeria', dialCode: '+213', flag: '🇩🇿', retail: 5.00 },
  GH: { name: 'Ghana', dialCode: '+233', flag: '🇬🇭', retail: 5.00 },
  TZ: { name: 'Tanzania', dialCode: '+255', flag: '🇹🇿', retail: 5.00 },
  UG: { name: 'Uganda', dialCode: '+256', flag: '🇺🇬', retail: 5.00 },
  CI: { name: 'Ivory Coast', dialCode: '+225', flag: '🇨🇮', retail: 5.00 },
  SN: { name: 'Senegal', dialCode: '+221', flag: '🇸🇳', retail: 5.00 },
  CM: { name: 'Cameroon', dialCode: '+237', flag: '🇨🇲', retail: 5.00 },
  MA: { name: 'Morocco', dialCode: '+212', flag: '🇲🇦', retail: 5.00 },
  TN: { name: 'Tunisia', dialCode: '+216', flag: '🇹🇳', retail: 5.00 },
  JM: { name: 'Jamaica', dialCode: '+1876', flag: '🇯🇲', retail: 5.00 },
  TT: { name: 'Trinidad and Tobago', dialCode: '+1868', flag: '🇹🇹', retail: 5.00 },
  DO: { name: 'Dominican Republic', dialCode: '+1809', flag: '🇩🇴', retail: 5.00 },
  PR: { name: 'Puerto Rico', dialCode: '+1787', flag: '🇵🇷', retail: 5.00 },
  PA: { name: 'Panama', dialCode: '+507', flag: '🇵🇦', retail: 5.00 },
  CR: { name: 'Costa Rica', dialCode: '+506', flag: '🇨🇷', retail: 5.00 },
  EC: { name: 'Ecuador', dialCode: '+593', flag: '🇪🇨', retail: 5.00 },
  UY: { name: 'Uruguay', dialCode: '+598', flag: '🇺🇾', retail: 5.00 },
  GT: { name: 'Guatemala', dialCode: '+502', flag: '🇬🇹', retail: 5.00 },
  SV: { name: 'El Salvador', dialCode: '+503', flag: '🇸🇻', retail: 5.00 },
  HN: { name: 'Honduras', dialCode: '+504', flag: '🇭🇳', retail: 5.00 },
  BO: { name: 'Bolivia', dialCode: '+591', flag: '🇧🇴', retail: 5.00 },
  PY: { name: 'Paraguay', dialCode: '+595', flag: '🇵🇾', retail: 5.00 },
  LT: { name: 'Lithuania', dialCode: '+370', flag: '🇱🇹', retail: 5.00 },
  LV: { name: 'Latvia', dialCode: '+371', flag: '🇱🇻', retail: 5.00 },
  EE: { name: 'Estonia', dialCode: '+372', flag: '🇪🇪', retail: 5.00 },
  SK: { name: 'Slovakia', dialCode: '+421', flag: '🇸🇰', retail: 5.00 },
  SI: { name: 'Slovenia', dialCode: '+386', flag: '🇸🇮', retail: 5.00 },
  HR: { name: 'Croatia', dialCode: '+385', flag: '🇭🇷', retail: 5.00 },
  RS: { name: 'Serbia', dialCode: '+381', flag: '🇷🇸', retail: 5.00 },
  BA: { name: 'Bosnia and Herzegovina', dialCode: '+387', flag: '🇧🇦', retail: 5.00 },
  MK: { name: 'North Macedonia', dialCode: '+389', flag: '🇲🇰', retail: 5.00 },
  AL: { name: 'Albania', dialCode: '+355', flag: '🇦🇱', retail: 5.00 },
  MT: { name: 'Malta', dialCode: '+356', flag: '🇲🇹', retail: 6.00 },
  CY: { name: 'Cyprus', dialCode: '+357', flag: '🇨🇾', retail: 6.00 },
  LU: { name: 'Luxembourg', dialCode: '+352', flag: '🇱🇺', retail: 6.00 },
  IS: { name: 'Iceland', dialCode: '+354', flag: '🇮🇸', retail: 7.00 },
  PK: { name: 'Pakistan', dialCode: '+92', flag: '🇵🇰', retail: 4.00 },
  BD: { name: 'Bangladesh', dialCode: '+880', flag: '🇧🇩', retail: 4.00 },
  LK: { name: 'Sri Lanka', dialCode: '+94', flag: '🇱🇰', retail: 5.00 },
  NP: { name: 'Nepal', dialCode: '+977', flag: '🇳🇵', retail: 5.00 },
  MM: { name: 'Myanmar', dialCode: '+95', flag: '🇲🇲', retail: 5.00 },
  KH: { name: 'Cambodia', dialCode: '+855', flag: '🇰🇭', retail: 5.00 },
  LA: { name: 'Laos', dialCode: '+856', flag: '🇱🇦', retail: 5.00 },
  BN: { name: 'Brunei', dialCode: '+673', flag: '🇧🇳', retail: 6.00 },
  MV: { name: 'Maldives', dialCode: '+960', flag: '🇲🇻', retail: 6.00 },
  QA: { name: 'Qatar', dialCode: '+974', flag: '🇶🇦', retail: 7.00 },
  KW: { name: 'Kuwait', dialCode: '+965', flag: '🇰🇼', retail: 7.00 },
  BH: { name: 'Bahrain', dialCode: '+973', flag: '🇧🇭', retail: 7.00 },
  OM: { name: 'Oman', dialCode: '+968', flag: '🇴🇲', retail: 7.00 },
  JO: { name: 'Jordan', dialCode: '+962', flag: '🇯🇴', retail: 6.00 },
  LB: { name: 'Lebanon', dialCode: '+961', flag: '🇱🇧', retail: 6.00 },
  GE: { name: 'Georgia', dialCode: '+995', flag: '🇬🇪', retail: 5.00 },
  AM: { name: 'Armenia', dialCode: '+374', flag: '🇦🇲', retail: 5.00 },
  AZ: { name: 'Azerbaijan', dialCode: '+994', flag: '🇦🇿', retail: 5.00 },
  MD: { name: 'Moldova', dialCode: '+373', flag: '🇲🇩', retail: 5.00 },
  BY: { name: 'Belarus', dialCode: '+375', flag: '🇧🇾', retail: 5.00 },
  KZ: { name: 'Kazakhstan', dialCode: '+7', flag: '🇰🇿', retail: 5.00 },
  UZ: { name: 'Uzbekistan', dialCode: '+998', flag: '🇺🇿', retail: 5.00 },
}

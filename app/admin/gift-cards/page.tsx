...
function AdminGiftCardsPageContent() {
  ...
  const filteredGiftCards = giftCards.filter(card => {
    const matchesSearch = card.brand.toLowerCase().includes(gcSearchQuery.toLowerCase())
    const matchesCategory = gcSelectedCategory === 'all' || card.category === gcSelectedCategory
    const matchesStatus = gcSelectedStatus === 'all' ||
      (gcSelectedStatus === 'active' && card.isActive) ||
      (gcSelectedStatus === 'inactive' && !card.isActive)
